# Inventory Analysis in Power BI — Case Study
...
- Which products are most valuable? (ABC Analysis)
- Where can purchasing and stock control be improved?

## What's Inside
### Exploratory Analysis

- Connected and loaded the raw inventory dataset
- Used Power Query to clean, transform, and validate the data
- Calculated foundational metrics: Revenue, Profit, and COGS

### Inventory Analysis

- Built intermediate DAX measures for deeper analysis
- Computed Inventory Turnover to assess stock efficiency
- Performed ABC Analysis to classify products by revenue contribution
